...
| top | inside (아래) | right | 왼쪽→아래 | 90 |
| top | outside (위) | left | 오른쪽→위 | -90 |
| top | outside (위) | right | 왼쪽→위 | 180 |
| bottom | inside (위) | left | 오른쪽→위 | 180 |
| bottom | inside (위) | right | 왼쪽→위 | -90 |
| bottom | outside (아래) | left | 오른쪽→아래 | 90 |
| bottom | outside (아래) | right | 왼쪽→아래 | 180 |
...
| right | inside (왼쪽) | left (위) | 아래→왼쪽 | 180 |
| right | inside (왼쪽) | right (아래) | 위→왼쪽 | 90 |
